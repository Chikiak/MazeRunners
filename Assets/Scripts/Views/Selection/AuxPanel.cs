    ...
    private void OnEnable()
        {
            ...
            _selection.sosManager = _SOsManager;
            _selection.OnTokenSelected += OnTokenSelected;
        ...
        /*private void HandleSelection(ITokenController tokenController)
        {  
            OnTokenSelected?.Invoke(tokenController);
        }*/
